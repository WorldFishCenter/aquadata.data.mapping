...
This outlines how to propose a change to aquadata.data.mapping. For more
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("WorldFishCenter/aquadata.data.mapping", fork = TRUE)`.
...
[Contributor Code of
Conduct](https://worldfishcenter.github.io/aquadata.data.mapping/CODE_OF_CONDUCT.md).
